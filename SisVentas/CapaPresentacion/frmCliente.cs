...
namespace CapaPresentacion
{
    public partial class frmCliente : Form
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
              try
            {
                ...
                else
                {
                    ...
                    if (IsNuevo)
                    {
                        rpta = NCliente.Insertar(this.txtNombre.Text.Trim().ToUpper(), //Trim es para borrar espacios en blanco
        ...
        {
            if (!this.txtIdcliente.Text.Equals("")) //Este ! indica sino esta vacia
            {
