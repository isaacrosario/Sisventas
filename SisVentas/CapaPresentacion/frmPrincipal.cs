...
namespace CapaPresentacion
{
    public partial class frmPrincipal : Form
    {
        ...
        private void trabajdoresToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void ingresosToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            frm.MdiParent = this;
            frm.Show();
            frm.idtrabajador = Convert.ToInt16(this.Idtrabajador);
        }
        ...
        {
            Consultas.FrmConsulta_Stock_Articulo frm = new Consultas.FrmConsulta_Stock_Articulo();
            frm.MdiParent = this;
            frm.Show();
        }
    }
