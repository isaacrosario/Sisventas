...
namespace CapaPresentacion
{
    ...
    {
        //Indicar si es  nuebvo lo que se va registrar o solo es para editar
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (IsNuevo)
                    {
                        rpta = NArticulo.Insertar(this.txtCodigo.Text, this.txtNombre.Text.Trim().ToUpper(), //Trim es para borrar espacios en blanco
                    ...
                    else
                    {
                        rpta = NArticulo.Editar(Convert.ToInt32(this.txtIdarticulo.Text),
                            this.txtCodigo.Text, this.txtNombre.Text.Trim().ToUpper(), //Trim es para borrar espacios en blanco
                            this.txtDescripcion.Text.Trim(), imagen, 
