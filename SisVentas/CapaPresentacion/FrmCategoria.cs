...
namespace CapaPresentacion
{
    public partial class FrmCategoria : Form
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (IsNuevo)
                    {
                        rpta = NCategoria.Insertar(this.txtNombre.Text.Trim().ToUpper(), //Trim es para borrar espacios en blanco
        ...
        {
            if (!this.txtIdcategoria.Text.Equals("")) //Este ! indica sino esta vacia
            {
