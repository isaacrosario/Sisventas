...
namespace CapaDatos
{
    public class DTrabajador
    {
        ...
        //Este contructori recibe todos los parametros
        ...
        public string Insertar(DTrabajador Trabajador)
        {
            ...
            try
            {
                ...
                ParIdtrabajador.ParameterName = "@idtrabajador"; //good
                ...
                ParNombre.SqlDbType = SqlDbType.VarChar; //good
                ParNombre.Size = 20;
                ...
                ParApellidos.SqlDbType = SqlDbType.VarChar; //good
                ...
                ParSexo.SqlDbType = SqlDbType.VarChar; //good
                ParSexo.Size = 1;
                ...
                Parfecha_Nacimiento.SqlDbType = SqlDbType.Date; //good
                ...
                ParNum_Documento.SqlDbType = SqlDbType.VarChar;//good
                ...
                ParDireccion.SqlDbType = SqlDbType.VarChar; //good
                ...
                ParTelefono.SqlDbType = SqlDbType.VarChar; //good
                ParTelefono.Size = 10;
                ...
                ParEmail.SqlDbType = SqlDbType.VarChar; //good
                ParEmail.Size = 50;
                ...
                ParAcceso.SqlDbType = SqlDbType.VarChar; //good
                ParAcceso.Size = 20;
        ...
        public DataTable BuscarApellidos(DTrabajador Trabajador)
        {
            ...
            try
            {
                ...
                SqlCommand SqlCmd = new SqlCommand();
                SqlCmd.Connection = SqlCon;
                SqlCmd.CommandText = "spbuscar_trabajor_apellidos";
                SqlCmd.CommandType = CommandType.StoredProcedure;
